...
1. When you add your list with 'shift+enter' keys together, It marks that item as 'priority' which is it highlighted with the '!' icon.
2. To add a task, click the '+' icon or press the 'enter' key. 
3. Priority tasks are at the top of the list.
4. A task gets moved to the bottom of the list once it is done. 
